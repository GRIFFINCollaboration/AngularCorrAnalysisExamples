...
//   Method4a2a4(graph,0.9554,0.003,0.849,0.003,true); // these values are guesses for 586-2013
   Method4mixing(graph,0.9554,0.003,0.849,0.003,"results.txt"); // these values are guesses for 586-2013
}
